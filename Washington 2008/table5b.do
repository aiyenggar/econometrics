...
qui tab statabb, gen(sdum)

capture program drop _all
program define doit
foreach var of varlist voteyesv1-voteyesv1166{
qui reg `var' ngirls white female repub   age agesq srvlng srvlngsq demvote reld* chid*  sdum* medinc percol perw perf  perur
...
use 108btemp
append using 107btemp
append using 106btemp
append using 105btemp
sort congress voteno
